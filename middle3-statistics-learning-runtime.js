(function (root, factory) {
  const api = factory(
    ...
    root?.STUDY_MIDDLE3_STATISTICS_LEARNING_MODEL || (typeof require === "function" ? require("./middle3-statistics-learning-model.js") : null),
    root?.STUDY_MIDDLE3_STATISTICS_LEARNING_CONTENT || (typeof require === "function" ? require("./middle3-statistics-learning-content.js") : null)
  );
  if (typeof module === "object" && module.exports) module.exports = api;
  if (root) root.STUDY_M3_STATISTICS_LEARNING_RUNTIME = api;
  ...
  return factory.createUnitRuntime({ runtimeFactory, schema, algebraValidator: algebra, model, content,
    version: "middle3StatisticsLearningV1", scopeId: "MIDDLE3_STATISTICS", curriculumVersion: "MIDDLE3_2015_STATISTICS_V1",
    cloudKey: "middle3StatisticsLearningV1", localStorageKey: "studyCoinMiddle3StatisticsLearningV1", cyclePrefix: "m3stats-cycle", eventName: "study:m3-statistics-remote-wins" });
});
